...
function Home() {
    return (
        <>
            ...
            <div id={"biography"}>
                <div className={"picture_biography"}><img src="./img/Imagine-Dragons.jpg" alt=""/></div>
            ...
            <div id={"album"}>
                ...
                <div>
                    ...
                    <Link to="/Album"><div><ButtonMore color={"#570b0b"}/></div></Link>
                </div>
            </div>
            ...
            <div id={"gallery"}>
                ...
                <div className={"gallery_review"}>
                   ...
                   <Link to="/Gallery"><ButtonMore color={"red"}/></Link>
            </div>
        </>
    )
}
